...
puts "Total revenue average: #{Store.sum("annual_revenue")/Store.count}"
...
puts "Annual sales > $1M: #{Store.where("annual_revenue >= 1000000",
  {annual_revenue: [:annual_revenue]}).count}"